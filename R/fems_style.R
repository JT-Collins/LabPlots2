...
fems_style <- function(colPal = c("pal1","pal2", "pal3")) {
  ...
  ggplot2::theme_set(
    hrbrthemes::theme_ipsum(
      ...
      axis_col = "#343D46",
      ticks = TRUE,
      base_size = 16/ggplot2::.pt,
      plot_margin = ggplot2::margin(2, 2, 2, 2),
      plot_title_size = 16/ggplot2::.pt,
      subtitle_size = 16/ggplot2::.pt,
      subtitle_margin = 4,
      axis_title_size = 16/ggplot2::.pt,
      strip_text_size = 16/ggplot2::.pt,
      caption_size = 16/ggplot2::.pt ,
      caption_face = "plain",
      caption_margin = 4
    ) + theme(text = element_text(colour = black_text),
              axis.line = element_line(linewidth = 1.5/ggplot2::.lwt),
