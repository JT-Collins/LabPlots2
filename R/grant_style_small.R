  ...
  ggplot2::theme_set(
    hrbrthemes::theme_ipsum(
      ...
      caption_margin = 3
              ...
              plot.title = ggtext::element_textbox_simple(color = dark_text, lineheight = 1.05,
                                                    margin = margin(b = 2.4),),
              plot.subtitle = ggtext::element_textbox_simple(lineheight = 1.05,
                                                             margin = margin(b = 1.8)),
              plot.caption = ggtext::element_textbox_simple(lineheight = 1.05,
