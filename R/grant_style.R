  ...
  ggplot2::theme_set(
    hrbrthemes::theme_ipsum(
      ...
      caption_margin = 4
                    ...
                    axis.text.y = element_text(size = 8, colour = black_text, margin = margin(r = 0.6)),
                    axis.text.x = element_text(size = 8, colour = black_text, margin = margin(t = 0.6)),
                    axis.text.x.top   = element_text(margin = margin(b = 0.6)),
                    axis.text.y.right = element_text(margin = margin(l = 0.6)),
